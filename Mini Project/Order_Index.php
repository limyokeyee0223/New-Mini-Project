<html>
    ...
    <body>
        ...
        <script>
            ...
            db.allDocs({ include_docs: true, descending: true }, (err, doc) => {
                ...
                doc.rows.forEach(e => {
                    ...
                    let fg = '<tr><td>' + coun + '</td><td>' + e.doc.username + '</td><td><img src="' + e.doc.image + '" height="100px" width="100px" class="rounded-pill"></td><td>' + e.doc.order_product_name + '</td><td>RM ' + e.doc.order_product_price + '</td><td><a class="button" href="Certificate.html?u=' + e.doc.invoice + '">Download Certificate<i class="fa fa-trash - alt"></i></a></td></tr>';
        ...
        <div class="container-fluid" style="margin-top:80px">
            ...
            <!-- <center><a href="Order_Add.php"><button class="btn-lg" type="button">Add</button></a><center> -->
            </div>
        </div><br><br><br><br>
