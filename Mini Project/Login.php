    ...
    <head>
        ...
        <style>
            ...
            body 
            {
                ...
                background: -webkit-linear-gradient(to right, rgba(186, 132, 245, 1), rgba(124, 172, 252, 1));
          
                /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
                background: linear-gradient(to right, rgba(186, 132, 245, 1), rgba(124, 172, 252, 1))
            }
            ...
            .invalid  /* Add a red text color and an "x" when the requirements are wrong */
            {
                color: red;
            }
            .invalid:before 
    ...
    <body>
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
            <div class="container-fluid">
                <img src="Mini_project/icon.png" alt="Avatar Logo" style="width:50px;" class="rounded-pill">
        ...
        <script>
            ...
            if (queryString) 
            {
                alert("The account has been created. Please Log in")
            }
        </script>

        <div class="container-fluid" style="margin-top:80px">
            <form class="w-100 px-4 py-5" style="border-radius: .5rem .5rem 0 0;" name="login_form" method="post" >
                <div class="row d-flex justify-content-center">
                    <div class="col-12 col-md-8 col-lg-6 col-xl-6">
                        <div class="card bg-dark text-white" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                            <div class="mb-md-5 mt-md-4 pb-5">
                            <h1 class="fw-bold mb-2 text-uppercase">Login</h1><br>
                            ...
                            <p class="small mb-5 pb-lg-2"><a class="text-white-50" href="Forgot_Password.html">Forgot password?</a></p>
          
                            <button class="btn btn-outline-light btn-lg px-5" type="button" name="login" onclick="loginform()"><b>LOGIN</b></button></div>
        ...
        <script>
            ...
            // db.get("001123" , function(err, doc) 
            // {
            //     if (err) 
            //     {
            //          console.log(err);
            //          // window.location.replace("login.php?e=exits");
            //          // return false;
            //     } 
            //     else 
            //     {
            //          console.log(doc);
            //          // window.location.replace("Register_Add.php");
            ...
            function loginform()
            {
                ...
                if(username == "admin" && psw =="adminAdmin123")
                {
                    window.location.assign("Register_Index.php"); 
                    // alert("admin login");
                ...
                else
                {
                    ...
                    db.get('001' + username).then((doc) => {

                        if(doc.username == username && doc.psw == psw)
                        {
                            window.location.replace("Home.html?user=001" + username);
                        }
                        else
                        {
                            alert("Invalid");
