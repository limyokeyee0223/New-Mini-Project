<html>
    <head>
        ...
        <style>
            ...
            body 
            {
                ...
                background: -webkit-linear-gradient(to top, rgba(151, 149, 239, 1), rgba(249, 197, 209, 1));

                /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
                background: linear-gradient(to top, rgba(151, 149, 239, 1), rgba(249, 197, 209, 1))
            }
    ...
    <body>
        ...
        <div class="container-fluid" style="margin-top:80px">
            <form name="add_customer" class="w-100 px-4 py-5" style="border-radius: .5rem .5rem 0 0;" method="post">
                <div class="row d-flex justify-content-center">
                    <div class="col-12 col-md-8 col-lg-6 col-xl-6">
                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                
                    <h1 class="fw-bold mb-2 text-uppercase">Add Information</h1><br>
                    <table>
                        <tr>
                            <th>Name: </th>
                    ...
                    <center><button class="btn btn-outline-light btn-lg px-5" type="submit" name="submit"><b>SUBMIT</b></button></center>
